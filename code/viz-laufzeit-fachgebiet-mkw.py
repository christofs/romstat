...
def prepare_data(data): 
	...
	data = data.fillna(0)
	data = data.loc[:,["include", "dauer_cat", "domain_mkw"]]
	data = data[data["include"] == 1]
	data = data[data["domain_mkw"] == 1]
	print(data.head())
	n = data.shape[0]
...
def viz(data,n): 
	...
	chart = pygal.HorizontalBar(
		...
		legend_box_size=24,
		range = (0,50))
	chart.title = "Vertragslaufzeiten (nur Medien- und Kulturw.)"
	...
	chart.render_to_file("../img/romanistik_laufzeit-fachgebiet-mkw.svg")
