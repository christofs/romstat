...
def get_data(): 
	with open("romanistik-stellen-datensatz_2021-07-30_bearbeitet.csv", "r", encoding="utf8") as infile: 
...
def viz_dauer(data): 
	...
	barchart = pygal.StackedBar(style=BlueStyle,
					     ...
					     legend_box_size=24,
					     truncate_legend=5)
	barchart.title = "Anteile der Vertragsdauern pro Jahr\n(Daten von romanistik.de, 03/2014-07/2021, Stellen: "+str(datenpunktesumme)+")"
	...
	barchart.render_to_file("romanistik_jahr-dauer_barchart.svg")
