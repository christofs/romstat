...
def prepare_data(data): 
	...
	data = data.fillna(0)
	data = data.loc[:,["include", "dauer_cat", "domain_lit"]]
	data = data[data["include"] == 1]
	data = data[data["domain_lit"] == 1]
	print(data.head())
	n = data.shape[0]
...
def viz(data,n): 
	...
	chart = pygal.HorizontalBar(
		...
		legend_box_size=24,
		range = (0,50))
	chart.title = "Vertragslaufzeiten (nur Literaturwiss.)"
	...
	chart.render_to_file("../img/romanistik_laufzeit-fachgebiet-lit.svg")
